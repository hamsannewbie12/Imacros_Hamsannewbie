var ongaisimai= Number(prompt("AUTO POSTING FBMP ANTI DUPLIKAT\n\nCreator 'Hamsan Newbie'\n\nAda 2 Perintah Dalam Script Ini:\n1=Tampilan Facebook Button Atas\n2=Tampilan Facebook Button Kiri\n ",1));


//AUTO UPLOAD VERSI TAMPILAN FACEBOOK BUTTON ATAS 
if (ongaisimai == 1) {
...
//AUTO UPLOAD VERSI TAMPILAN FACEBOOK BUTTON KIRI 
...
var sourcefile = imns.Dialogs.browseForFileOpen("Enter file location");
		...
		macro += "WAIT SECONDS={{!VAR3}}" + "\n";
		macro += "TAG POS=1 TYPE=A ATTR=aria-label:Lanjutkan&&role:link&&tabindex:0" + "\n";
		macro += "WAIT SECONDS={{!VAR3}}" + "\n";
		macro += "WAIT SECONDS={{!VAR3}}" + "\n";
